...
extension CupertinoContextExtension on BuildContext {
  ...
  TextStyle get displayLarge => GoogleFonts.nunito(
          fontSize: 57, fontWeight: FontWeight.w400, letterSpacing: 0)
  ...
  TextStyle get titleLarge => GoogleFonts.nunito(
          fontSize: 22, fontWeight: FontWeight.w400, letterSpacing: 0)
      .copyWith(inherit: true);
  ...
  Color get primaryColor => isDark
      ? CupertinoTheme.of(this).primaryContrastingColor
